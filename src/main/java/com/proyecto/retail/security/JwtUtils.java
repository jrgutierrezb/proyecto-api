package com.proyecto.retail.security;
...
public class JwtUtils {
    ...
    private String createToken(Map<String, Object> claims, String subject, String userId) {
        ...
        return Jwts.builder().setClaims(claims).setSubject(subject).setId(userId).setIssuedAt(new Date(System.currentTimeMillis()))
